...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Registration successful: Redirect to /login (DO NOT auto-login)
      navigate('/login', {
        replace: true,
        state: {
        ...
        <div className="bg-white/90 dark:bg-[#0f1118]/90 backdrop-blur-xl border border-slate-200 dark:border-white/10 rounded-3xl shadow-2xl shadow-black/5 dark:shadow-violet-950/20 p-8 sm:p-10 space-y-6">
          ...
          <div className="text-center space-y-3">
            ...
            <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400">
              Register to access the neural classification workspace.
            </p>
          </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 sm:py-3 rounded-xl bg-slate-50 dark:bg-[#090a10] border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white placeholder-slate-400 text-sm focus:outline-none focus:border-violet-500 focus:ring-2 focus:ring-violet-500/20 transition-all"
                  autoComplete="name"
                  required
                />
              </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-11 py-2.5 sm:py-3 rounded-xl bg-slate-50 dark:bg-[#090a10] border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white placeholder-slate-400 text-sm focus:outline-none focus:border-violet-500 focus:ring-2 focus:ring-violet-500/20 transition-all"
